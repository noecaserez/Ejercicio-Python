...
clientes se guardarán en un diccionario en el que la clave de cada cliente será su ID, y el valor
...
datos.
2. Preguntar por el ID del cliente y eliminar sus datos de la base de datos.
3. Preguntar por el ID del cliente y mostrar sus datos.
4. Mostrar lista de todos los clientes de la base datos con su ID y nombre.
5. Mostrar la lista de clientes preferentes de la base de datos con su ID y nombre.
